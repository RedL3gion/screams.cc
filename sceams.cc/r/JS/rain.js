//i did not make this it was a public js however i lost the link.
...
demo.drop_delay = 150; // Adjust this value to control the frequency of raindrops
...
while (demo.drop_time > demo.drop_delay) {
    ...
    // Adjust the divisor (25) to reduce the frequency of raindrops
